...
<html lang="en">
<head>
<title>漂亮的响应式Bootstrap后台管理系统模板MatAdmin</title>
<meta charset="UTF-8" />
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 控制台</a>
  <ul>
    <li class="active"><a href="index.index.jsp"><i class="icon icon-home"></i> <span>首页</span></a> </li>
    <li> <a href="charts.html"><i class="icon icon-signal"></i> <span>健康监测</span></a> </li>
    ...
    <li> <a href="healthindex.html"><i class="icon icon-th-list"></i> <span>表单</span> </a></li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.index.jsp" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a></div>
  </div>
<!--End-breadcrumbs-->
  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="index.index.jsp"> <i class="icon-dashboard"></i> <span class="label label-important">20</span> 我的控制台</a> </li>
        <li class="bg_lg span3"> <a href="charts.html"> <i class="icon-signal"></i> 健康监护</a> </li>
        ...
        <li class="bg_lo span3"> <a href="healthindex.html"> <i class="icon-th-list"></i> 表单</a> </li>
